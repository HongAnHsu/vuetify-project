...
const routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'local',
        name: 'Local',
        component: () => import(/* webpackChunkName: "local" */ '@/views/front/LocalView.vue'),
        meta: {
          title: '找。漢堡 Found。Burger| 店面資訊',
          login: false,
          admin: false
        }
      }
